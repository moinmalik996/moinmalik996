...
**Programming:** C/C++, Python, JavaScript, TypeScript, Asynchronous Programming
**Backend:** Django, Flask, FastAPI, NodeJS, REST APIs
**Databases:** Postgres, MySQL, Microsoft SQL, MongoDB, DynamoDB
**Frontend:** jQuery, NextJS, React, Redux, Vite
**Infrastructure:** AWS, Docker, Microservices, Kubernetes, Terraform, CI/CD, Infrastructure as Code, Jenkins
**Monitoring:** Grafana, Prometheus, Datadog, New Relic, AWS CloudWatch, AWS Cost Automation Scripts, Resource Scheduling, CUR Analysis
**Tools:** Linux, Git, GitLab, Nginx, Redis, Celery, RabbitMQ, Apache Kafka
**CMS:** Odoo, Wagtail, Wordpress
